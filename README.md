...
This is a static api, taken from the JSON file in dedline.io, that anyone can access for election information (Updated for 2024!)

The base URL is https://dedline-api.netlify.app/. Please don't spam it. :)

Check out dedline.io if you want to see it in action!
